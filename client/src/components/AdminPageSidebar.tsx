...
export default function AdminPageSidebar({
  ...
  return (
    <>
      {open && (
        <div
          className="fixed z-10 w-screen h-screen backdrop-blur-sm animate-fade-in lg:hidden"
          onClick={closeSidebar}
        ></div>
      )}
      <div
        className={`top-0 h-screen bg-white lg:sticky text-zinc-700 shadow-md duration-200 flex gap-2 flex-col z-10 overflow-hidden fixed ${
          open ? "w-60 p-4" : "w-0 lg:w-14 px-0 py-4"
        }`}
      >
        <div className={`flex-col gap-2 ${open ? "px-4" : ""} flex-center`}>
          {loading ? (
            <>
              <div
                className={`${
            ...
            <Link
              ...
              className={`flex items-center gap-2 ${
                ...
                pathname === "/admin"
                  ...
                  : ""
              } duration-300 rounded-md hover:bg-accent-blue-100/20 focus-visible:bg-accent-blue-100/20 hover:text-accent-blue-300 group`}
            >
              <svg
                height={20}
                width={20}
                ...
                id="dashboard"
                className={`duration-300 group-focus-visible:fill-accent-blue-300 group-hover:fill-accent-blue-300 ${
                  pathname === "/admin" ? "fill-accent-blue-300" : ""
                }`}
              >
                    ...
                    >
                      ...
                      >
                        ...
                        <path
                          ...
                          id="Path"
                          stroke="#aaa"
                          className={`duration-300 group-focus-visible:stroke-accent-blue-300 group-hover:stroke-accent-blue-300 ${
                            pathname === "/admin/orders"
                              ? "stroke-accent-blue-300"
                              : ""
                          }`}
                          strokeWidth="2"
                          strokeLinecap="round"
        ...
        <button
          className="flex items-center gap-2 p-2 mx-2 mt-auto rounded-md hover:bg-zinc-100 "
