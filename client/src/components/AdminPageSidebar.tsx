...
export default function AdminPageSidebar({
  ...
  return (
    <>
      {open && (
        <div
          className="w-screen h-screen fixed z-10 backdrop-blur-sm animate-fade-in lg:hidden"
      ...
      >
        ...
        <button
          className="mt-auto mx-2 flex items-center gap-2 hover:bg-zinc-100 p-2 rounded-md "
