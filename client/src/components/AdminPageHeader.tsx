...
export default function AdminPageHeader({
  ...
  return (
    <>
      <nav className="sticky top-0 w-full flex items-center justify-between gap-4 p-2 mx-auto bg-white shadow-md">
        ...
        <button className="flex-center group relative" onClick={toggleDropdown}>
          <img
            src={store?.banner}
            alt={store?.name + " logo"}
            className="w-8 h-8 bg-zinc-300 rounded-full object-cover"
          />
          <span
          ...
          {dropdownIsOpen && (
            <div className="p-1 rounded-lg absolute top-[110%] bg-white border right-0 w-fit flex flex-col text-zinc-700">
              <Link
                to={"/"}
                className="group/dropdown p-2 py-1 text-start flex items-center gap-2 hover:bg-accent-blue-100/20 rounded-md duration-300 hover:text-accent-blue-300"
              >
                <svg
                  height={20}
                  width={20}
              ...
              <button
                ...
                className="p-2 py-1 group/dropdown text-start flex items-center gap-2 hover:text-red-700 hover:bg-red-100 rounded-md duration-300"
              >
                <svg
                  height={20}
                  width={20}
