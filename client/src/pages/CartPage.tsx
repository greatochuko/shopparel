...
export default function CartPage() {
  return (
    <main className="mt-[72px] mx-auto max-w-7xl w-[90%] pt-1">
      <h1 className="my-4 text-zinc-400 font-semibold">
      ...
      <div className="flex flex-col gap-4 overflow-x-scroll">
        <div className="flex justify-between gap-3 bg-zinc-700 uppercase py-4 last:border-none text-white">
