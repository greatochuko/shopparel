...
export default function AuthLinks({ forAuth }: { forAuth?: boolean }) {
  ...
  const standardLinkStyle =
    " hover:bg-accent-blue-100 hover:border-accent-blue-100 focus:ring-accent-blue-100 focus:ring-2 active:bg-accent-blue-200 border-zinc-400 hover:text-white text-accent-blue-100";
