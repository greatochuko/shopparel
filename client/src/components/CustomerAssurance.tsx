const aboutInfos = [
  {
    ...
    svg: (
      <svg
        ...
        stroke="#000000"
        className="fill-accent-blue-300"
...
export default function CustomerAssurance() {
  return (
    <div className="flex gap-4 lg:gap-8 w-full items-start max-w-7xl px-4 md:p-4 md:w-fit bg-white text-zinc-800 flex-col md:flex-row z-[2] mx-auto">
      {aboutInfos.map((info) => (
        <div className="flex flex-col items-start flex-1 gap-4 p-4">
