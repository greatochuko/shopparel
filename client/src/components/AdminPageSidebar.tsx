...
export default function AdminPageSidebar({
  ...
  return (
    <div
      className={`sticky top-0 h-screen bg-white  text-zinc-700 shadow-md duration-200 flex gap-2 flex-col z-10 overflow-hidden ${
        open ? "w-60 p-4" : "w-0 px-0"
      }`}
    >
      <div className="flex-center flex-col gap-2 px-4">
        {loading ? (
          <>
            <div className="h-20 w-20 rounded-full animate-pulse bg-zinc-300"></div>
            <div className="w-32 h-5 animate-pulse rounded-full bg-zinc-300"></div>
          </>
        ) : (
          <>
            <img
              src={store?.banner}
              alt=""
              className="w-20 rounded-full h-20 shadow object-cover"
            />
      ...
      <ul className="flex flex-col gap-1">
        <li>
          ...
          <Link
            to={"/admin"}
            className="p-3 hover:bg-accent-blue-100/20 hover:text-accent-blue-300 group flex items-center gap-2 duration-300 rounded-md"
          >
            <svg
              height={20}
              width={20}
              ...
              id="dashboard"
              className="group-hover:fill-accent-blue-300 duration-300"
            >
              ...
              <g id="SVGRepo_iconCarrier">
                ...
                <g id="shop" transform="translate(-1725.809 -1186.416)">
                  ...
                  <path
                    id="Path_4"
                    data-name="Path 4"
                    d="M2032.055,1317.243a12.286,12.286,0,0,0-1.558-5.643l-36.515-69.051v-44.284a11.81,11.81,0,0,0-12.02-11.849H1776.009a11.816,11.816,0,0,0-12.027,11.849v44.276l-36.512,69.044a12.405,12.405,0,0,0-1.661,5.659,28.769,28.769,0,0,0,12.173,23.136V1466.6c0,15.372,12.856,27.82,28.081,27.82h225.579c15.371,0,28.34-12.449,28.34-27.821V1340.269A28.6,28.6,0,0,0,2032.055,1317.243Zm-62.073-106.827v23h-182v-23Zm-186.672,47h191.338l32.364,61.6a3.7,3.7,0,0,1-3.017,1.7l-250.251.031a3.583,3.583,0,0,1-2.923-1.707Zm120.672,213h-50v-55.773a25,25,0,1,1,50,0Zm87.66,0h-63.66v-55.774a49.5,49.5,0,0,0-99,0v55.773h-62.919c-1.864,0-3.081-1.809-3.081-3.82v-121.18h232v121.179A3.644,3.644,0,0,1,1991.642,1470.416Z"
                    fill="#aaa"
                    className="group-hover:fill-accent-blue-300 duration-300"
                  ></path>{" "}
                </g>{" "}
                  ...
                  >
                    ...
                    >
                      ...
                      <path
                        ...
                        id="Path"
                        stroke="#aaa"
                        className="group-hover:stroke-accent-blue-300 duration-300"
                        strokeWidth="2"
                        strokeLinecap="round"
                      >
                        {" "}
